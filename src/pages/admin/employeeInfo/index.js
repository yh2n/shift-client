...
export default class AdminEmployeeInfo extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    let body;
    if (this.state.error) {
      body = <div className="error_message">{this.state.error}</div>;
    } else {
        ...
        <div className="info_container">
          <div className="admin_employee_dashboard">
            <div className="admin_employee_info">
              ...
              <Link
                to={`/admin/employee-availability/${employee.id}`}
                style={{
                  textDecoration: "none",
                  color: "#26A56A"
                }}
          ...
          <Link to={"/admin"} style={{ textDecoration: "none" }}>
            <div className="employee-database_redirect">Back to schedule</div>
          </Link>
        </div>
      );
    }
    ...
    return (
      <div>
        ...
        <div className="employee_contact_info">{body}</div>
      </div>
    );
  }
}

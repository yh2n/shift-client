...
export class Schedule extends Component {
    ...
    componentDidMount() {
        ...
        window.innerWidth < 568 ? this.setState({ device: "mobile" }) : this.setState({ device: "desktop" });
	...
	render() {
        ...
        let barbackRow = (
                barbacks.map(barback => (
                        <AdminEmployeeRow
                            key={barback.id}
                            className={barback.id === currentUserId ? "admin_schedule_name logged_in" : "admin_schedule_name"}
                            name={
        ...
        let bartenderRow = (
                bartenders.map(bartender => (
                        <AdminEmployeeRow
                            key={bartender.id}
                            className={bartender.id === currentUserId ? "admin_schedule_name logged_in" : "admin_schedule_name"}
                            name={
        ...
        let busserRow = (
                bussers.map(busser => (
                        <AdminEmployeeRow
                            key={busser.id}
                            className={busser.id === currentUserId ? "admin_schedule_name logged_in" : "admin_schedule_name"}
                            name={
        ...
        let baristaRow = (
                baristas.map(barista => (
                        <AdminEmployeeRow
                            key={barista.id}
                            className={barista.id === currentUserId ? "admin_schedule_name logged_in" : "admin_schedule_name"}
                            name={
        ...
        let hostRow = (
                hosts.map(host => (
                        <AdminEmployeeRow
                            key={host.id}
                            className={host.id === currentUserId ? "admin_schedule_name logged_in" : "admin_schedule_name"}
                            name={
        ...
        let maitreDRow = (
                maitre_ds.map(maitre_d => (
                        <AdminEmployeeRow
                            key={maitre_d.id}
                            className={maitre_d.id === currentUserId ? "admin_schedule_name logged_in" : "admin_schedule_name"}
                            name={
        ...
        let managerRow = (
                managers.map(manager => (
                        <AdminEmployeeRow
                            key={manager.id}
                            className={manager.id === currentUserId ? "admin_schedule_name logged_in" : "admin_schedule_name"}
                            name={
        ...
        let runnerRow = (
                runners.map(runner => (
                        <AdminEmployeeRow
                            key={runner.id}
                            className={runner.id === currentUserId ? "admin_schedule_name logged_in" : "admin_schedule_name"}
                            name={
        ...
        let serverRow = (
                servers.map(server => (
                        <AdminEmployeeRow
                            key={server.id}
                            className={server.id === currentUserId ? "admin_schedule_name logged_in" : "admin_schedule_name"}
                            name={
        ...
        let sommelierRow = (
                sommeliers.map(sommelier => (
                        <AdminEmployeeRow
                            key={sommelier.id}
                            className={sommelier.id === currentUserId ? "admin_schedule_name logged_in" : "admin_schedule_name"}
                            name={

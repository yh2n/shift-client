        ...
        <div className="instructions">
          <div className="admin_instructions_div">
            <ul>
              ...
              <li>
                Create new schedules by clicking on the shifts you wish to
                select
              </li>
              <li>Submit your changes: each staff member gets notified </li>
            </ul>
          </div>
          ...
          <div className="staff_instructions_div">
            <ul>
              ...
              <li>
                Click on the shift(s) you are requesting coverage for: they will
                turn red and indicate your request <br />
                Click on the days off you are willing to work: they will turn
                green and show you are available/looking to pick up those shifts
              </li>
              <li>
                Submit your update(s): everyone gets notified of the latest
                schedule request(s)
              </li>
            </ul>
          </div>
          ...
          <div>
            <li className="pw_instructions" style={{ listStyle: "none" }}>
              Use{" "}
              <span
                style={{
                  fontStyle: "italic",
          ...
          <div className="staff_instructions_div">
            <ul>
              ...
              <li>
                Log in as manager from one window and as employee from the other
              </li>
              <li>
                Create and edit schedules, submit your availability and your
                schedule requests
              </li>
